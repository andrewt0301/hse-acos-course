...
* The exam is oral: 20 minutes for a preparation and 10 minutes for an answer.
* No materials are allowed.
* Exam tickets include 2 theoretical questions on topics:
...
An answer to each question is expected to take ~5 minutes.
